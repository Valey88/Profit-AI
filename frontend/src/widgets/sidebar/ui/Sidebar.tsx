...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside className={`
        fixed inset-y-0 left-0 z-50 w-[260px] glass-panel flex flex-col h-full transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:shrink-0
        ...
        <div className="p-6 flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-sm text-white tracking-wide leading-none">Profit AI</span>
        ...
        <div className="p-4 border-t border-white/5 mt-auto">
          <div className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-white/5 transition-colors cursor-pointer group border border-transparent hover:border-white/5">
            ...
            <div className="overflow-hidden flex-1">
              ...
              <p className="text-zinc-500 text-[10px] truncate group-hover:text-zinc-400">{user?.email || 'Loading...'}</p>
            </div>
            <button
              onClick={(e) => {
                e.stopPropagation();
